 ...
 */
export function getMainArticleText() {
 ...
 */
export function getBodyTextExcludingNavigation() {
 ...
 */
export function highlightText(text, className = 'accessible-web-highlight') {
    if (!text.trim())
        return;
 ...
 */
export function removeHighlights(className = 'accessible-web-highlight') {
 ...
 */
export function showPageNotification(message, type = 'info', duration = 3000) {
