...
export class AIClient {
     ...
     */
    generateGrade5Summary(text, maxSentences) {
        ...
        const scoredSentences = sentences.map(sentence => ({
            text: sentence.trim(),
            score: keyIndicators.reduce((score, indicator) => score + (sentence.toLowerCase().includes(indicator) ? 1 : 0), 0)
        }));
     ...
     */
    simplifySentenceForGrade5(sentence) {
        return sentence
     ...
     */
    extractVocabularyHelp(originalText, summary) {
